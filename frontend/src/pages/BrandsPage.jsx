      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage product brands</p>
          </div>
                ...
                <tbody>
                  ...
                  {brands.length === 0 ? (
                    ...
                    brands.map(b => (
                      ...
                      >
                        <td className="px-4 py-3 text-center text-sm text-gray-500 dark:text-gray-400 font-mono">{b.id}</td>
                        <td className="px-4 py-3 text-sm font-medium text-gray-900 dark:text-white">{b.name}</td>
                        <td className="px-4 py-3 text-center">{badge(b.status)}</td>
