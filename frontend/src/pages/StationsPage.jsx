      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage work stations</p>
          </div>
                ...
                <tbody>
                  ...
                  {stations.length === 0 ? (
                    ...
                    stations.map(s => (
                      ...
                      >
                        <td className="px-4 py-3 text-center text-sm text-gray-500 dark:text-gray-400 font-mono">{s.id}</td>
